...
type RenderableComponent = React.ComponentType | React.ExoticComponent | React.ReactElement | null | undefined;
/**
 ...
 */
export declare const isComponentClass: (value: unknown) => boolean;
/**
 ...
 * getValidComponent(<MyComponent />)
 */
export declare const getValidComponent: (component: RenderableComponent) => React.ReactElement | null;
export {};
