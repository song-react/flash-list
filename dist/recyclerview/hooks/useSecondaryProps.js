...
export function useSecondaryProps(props) {
    ...
    const renderFooter = useMemo(() => {
        ...
        return (React.createElement(CompatView, { style: [ListFooterComponentStyle, invertedTransformStyle] }, getValidComponent(ListFooterComponent)));
    ...
    const renderEmpty = useMemo(() => {
        ...
        return (React.createElement(CompatView, { style: [ListEmptyComponentStyle, invertedTransformStyle] }, emptyContent));
    }, [
        ListEmptyComponent,
        data,
    ...
    const renderStickyHeaderBackdrop = useMemo(() => {
        if (!(stickyHeaderConfig === null || stickyHeaderConfig === void 0 ? void 0 : stickyHeaderConfig.backdropComponent)) {
            return null;
        }
        return (React.createElement(CompatView, { style: [
                ...
                invertedTransformStyle,
            ] }, getValidComponent(stickyHeaderConfig === null || stickyHeaderConfig === void 0 ? void 0 : stickyHeaderConfig.backdropComponent)));
    }, [stickyHeaderConfig === null || stickyHeaderConfig === void 0 ? void 0 : stickyHeaderConfig.backdropComponent, invertedTransformStyle]);
    /**
    ...
    const CompatScrollView = useMemo(() => {
        ...
        if (typeof renderScrollComponent === "function" &&
            ...
            const ForwardedScrollComponent = React.forwardRef((_props, ref) => renderScrollComponent({
                ..._props,
                ref,
            }));
